  ...
  const buttonContent = (() => {
    if (os === "mac") {
      return {
        ...
        text: "Try Free for 7 Days — macOS",
      };
    } else if (os === "windows") {
      return {
        icon: (
        ...
        text: "Try Free for 7 Days — Windows",
      };
    }
    return {
        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <a
              ...
              className="px-4 py-2 rounded-full text-sm font-medium flex items-center gap-2 border border-white/20 hover:bg-white/10 transition-colors"
            >
      ...
      <section className="relative pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="animate-fade-in-up opacity-0 animate-delay-300 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              href="https://buy.polar.sh/polar_cl_d7JOsy8Bpxc4R2dSwlSsSisTTz2YM62MbtMxQ1ipxmK"
              className="px-8 py-4 rounded-full text-base font-medium flex items-center gap-2 border border-white/20 hover:bg-white/10 transition-colors"
            >
          ...
          <div className="feature-card rounded-2xl p-8 md:p-12">
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10">
              ...
              <div className="text-left">
                ...
                <a
                  href="/home"
                  className="btn-primary w-full md:w-auto px-8 py-4 rounded-xl text-base font-medium flex items-center justify-center gap-3 mb-3"
                >
                  {buttonContent.icon}
                  {buttonContent.text}
                </a>
                ...
                <a
                  href="https://buy.polar.sh/polar_cl_d7JOsy8Bpxc4R2dSwlSsSisTTz2YM62MbtMxQ1ipxmK"
                  className="w-full md:w-auto px-8 py-4 rounded-xl text-base font-medium flex items-center justify-center gap-3 mb-4 border border-white/20 hover:bg-white/10 transition-colors"
                >
                  <ShoppingCart className="w-5 h-5" />
                  Buy Now — {price}
                </a>
